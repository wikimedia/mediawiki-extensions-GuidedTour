...
$messages['ru'] = array(
	...
	'guidedtour-tour-gettingstarted-start-title' => 'Готовы помочь?',
	...
	'guidedtour-tour-firstedit-edit-section-description' => 'Cсылки «{{int:editsection}}» есть для каждого из основных разделов статьи, так что вы можете сосредоточиться только на конкретной её части.',
	'guidedtour-tour-firstedit-edit-section-visualeditor-description' => 'Cсылки «{{int:visualeditor-ca-editsource-section}}» есть для каждого из основных разделов статьи, так что вы можете сосредоточиться только на конкретной её части.',
